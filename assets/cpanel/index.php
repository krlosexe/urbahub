		                        	...
		                        	<div class="table-responsive">
			                            <form name="form_planes_registrar" id="form_planes_registrar" method="post">
				                            ...
				                            <div class="col-sm-4">
				                                ...
				                                <div class="form-group">
				                                    <div class="form-line">
				                                        <input type="text" class="form-control" name="precio" id="precio_registrar" onkeypress='return solonumeros(event)' placeholder="P. EJ. 2" required data-inputmask="'alias': 'numeric'">
				                                    </div>
				                                </div>
				                            </div>
                                			<br>
		                        	...
		                        	<div class="table-responsive">
			                            <form name="form_planes_editar" id="form_planes_editar" method="post">
				                            ...
				                            <div class="col-sm-4">
				                                ...
				                                <div class="form-group">
				                                    <div class="form-line">
				                                        <input type="text" class="form-control" name="precio" id="precio_editar" onkeypress='return solonumeros(event)' placeholder="P. EJ. 2" required data-inputmask="'alias': 'numeric'">
				                                    </div>
				                                </div>
				                            </div>
                                			<br>
