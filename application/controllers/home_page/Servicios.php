...
//	primera zona
		$consulta_meta_data = $this->Meta_etiquetas_model->meta_etiquetas_web(2);
...
//	primera zona
		...
		$consulta_bl_imagenes = $this->Bl_imagenes_model->buscar_imagenes_web("2");
		$data_imagenes = $consulta_bl_imagenes;
		$data["imagenes"] = $data_imagenes;

	 
		$consulta_texto = $this->Bl_textos_model->buscar_texto("2");
		$data_texto = json_decode($consulta_texto);
				   
		$data['textos'] = $data_texto;

		$this->load->view('portal/zona_servicios.php',$data);
...
// ultima zona
		...
		$this->load->view('portal/servicios');
		$this->load->view('portal/servicios1');
		$this->load->view('portal/info2');
