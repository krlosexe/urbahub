<head>
    ...
    <!-- Favicon-->
    <!--<link rel="icon" href="<?=base_url();?>assets/cpanel/images/LOGO(AF)-AG2-01.svg" type="image/x-icon">-->
    <!-- Google Fonts -->
    ...
    <!-- Jquery Core Js -->
    <script src="<?=base_url();?>assets/template/plugins/jquery/jquery.js"></script>
    <link href="<?=base_url();?>assets/template/plugins/font-awesome/css/font-awesome.css" rel="stylesheet" />
    <link href="<?=base_url();?>assets/template/plugins/sweetalert/sweetalert.css" rel="stylesheet" />
</head>