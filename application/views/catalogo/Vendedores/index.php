	...
	<body class="theme-blue">
		...
		<section class="content">
	        <div class="container-fluid">
		        ...
		        <!-- Comienzo del cuadro de registrar vendedores -->
						    ...
						    <div class="body">
						    	<div class="table-responsive">
							        <form name="form_vendedores_registrar" id="form_vendedores_registrar" method="post">
							            ...
							            <div style="border-bottom: 1px solid #ccc; display:none">
							              <h3>Proyectos</h3>
							          	</div>
							            ...
							            <div style="border-bottom: 1px solid #ccc;">
							          	...
							          	<div class="col-sm-12">
							            	<!--<div class="col-sm-6" style="padding-top: 10px;">
							                      ...
							                      <select id="proyecto_clientes_registrar"  class="form-control form-group">
							                      	<option value="">Seleccione un Proyecto</option>
							                      	<?php foreach($proyectos as $proyecto): ?>
							                      		<option value="<?php echo $proyecto["id_proyecto"] ?>"><?php echo $proyecto["codigo"]. " - " . $proyecto["nombre"]?></option>
							                      	<?php endforeach ?>
								            ...
								            <div class="col-sm-6" style="padding-top: 10px;">
								              	<label for="cliente_registrar">Clientes*</label>
								                      <select id="cliente_registrar" class="form-control form-group" >
								                      	<option value="">Seleccione</option>
		        ...
		        <!-- Cierre del cuadro de registrar vendedores -->

		        <!-- Comienzo del cuadro de consultar vendores -->
				<div class="row clearfix ocultar" id="cuadro3">
	                  ...
	                  <div class="card">
	                      ...
	                      <div class="body">
		                      	<div class="table-responsive">
		                            ...
		                            <div class="col-sm-12" style="margin-top: 5%;display: none">
		      	...
		      	<!-- Cierre del cuadro de consultar vendedores -->

	        <!-- Comienzo del cuadro de editar vendedores -->
	       ...
	       <!-- Cierre del cuadro de editar vendedores -->
			</div>
		</section>
	</body>
