...
<head>
  ...
  <title><?php if(isset($titulo)){print_r($titulo);}?></title>
  <meta name="description" content="<?php // if(isset($parrafos)){print_r($parrafos);}?>">
  
  <meta property="og:url"  content="https://urbanhub.mx/blog/articulo/<?php if(isset($id_art)){print_r($id_art);}?>" />
  <meta property="og:type"   content="" />
  <meta property="og:title"  content="<?php if(isset($titulo)){print_r($titulo);}?>" />
  <meta property="og:description"   content="<?php //if(isset($parrafos)){print_r($parrafos);}?>" />
  <meta property="og:image"         content="https://urbanhub.mx/assets/img/img-blog/<?php if(isset($imagen)){print_r($imagen);}?>" />
...
<div class="container-fluid" id="opciones_menu_cotainer" onclick="ocultar_menu()" >
  <div class="contenedor_opciones_menu">
    ...
    <div class="row">
        <div class="col-xl-2 col-lg-2 col-md-3 col-sm-8 col   pt-2">
        <button class="btn btn-warning btn-op-planes mr-auto d-block pb-2 pb-2 text-uppercase menu_opciones" id="" onclick="location.replace('../../Blog')"><strong>Noticias</strong></button>
        </div>
    </div>
    <div class="row">
        <div class="col-xl-2 col-lg-2 col-md-3 col-sm-8 col   pt-2">
