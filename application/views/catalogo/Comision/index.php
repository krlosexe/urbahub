	...
	<body class="theme-blue">
		...
		<section class="content">
	        <div class="container-fluid">
	        	...
	        	<!-- Comienzo del cuadro de la tablassss -->
		                                ...
		                                <table class="table table-bordered table-striped table-hover" id="tabla">
		                                    <thead>
		                                        <tr>
		                                            ...
		                                            <th>Indicador Venta al Mes</th>
		                                            <th>Ventas Min. al mes</th>
		                                            <th>Ventas Max. al mes</th>
		                                            <th>Tipo de Plazo</th>
		                                            <th>% Comisión</th>
		                        ...
		                        <div class="body">
		                        	<div class="table-responsive">
			                            <form name="form_comision_registrar" id="form_comision_registrar" method="post">
			                            	<div class="col-sm-4">
		                                    	...
		                                    	<select name="id_vendedor" id="id_vendedor_registrar" required class="form-control">
		                                    		...
		                                    		<?php foreach ($id_vendedores as $id_vendedor): ?>
		                                    			<option value="<?= $id_vendedor->id_lista_valor; ?>"><?= $id_vendedor->nombre_lista_valor; ?></option>
		                                    		<?php endforeach ?>
		                                    	</select>
				                            </div>
				                            <div class="col-sm-4">
				                            ...
				                            <div class="col-sm-2">
			                            		<label for="cod_esquema_registrar">Indicador de ventas de mes*</label>
		                                    	<div class="switch">
												    <label>
												      No
				                            ...
				                            <input type="hidden" name="indicador_venta_registrar" id="indicador_venta_registrar" value="N">

											<div class="col-sm-2">
			                            		<label for="num_ventas_min_mes_registrar">Ventas Min. al mes*</label>
				                                <div class="form-group">
				                                    <div class="form-line">
				                                        <input type="text" class="form-control" name="num_ventas_min_mes" id="num_ventas_min_mes_registrar" onkeypress='return solonumeros(event)' placeholder="P. EJ. 2" disabled>
				                                    </div>
				                                </div>
				                            </div>
				                            ...
				                            <div class="col-sm-2">
			                            		<label for="num_ventas_max_mes_registrar">Ventas Max. al mes*</label>
				                                <div class="form-group">
				                                    <div class="form-line">
				                                        <input type="text" class="form-control" name="num_ventas_max_mes" id="num_ventas_max_mes_registrar" onkeypress='return solonumeros(event)' placeholder="P. EJ. 2" disabled>
				                                    </div>
				                                </div>
				                            </div>
				                            ...
				                            <div class="col-sm-2">
				                                <label for="porctj_comision_registrar">% Comisión*</label>
				                                <div class="form-group">
				                                    <div class="form-line">
				                                        <input type="text" class="form-control" name="porctj_comision" id="porctj_comision_registrar" placeholder="P. EJ. 00.00" required onkeypress="return valida(event)" style="text-align: right;">
				                                    </div>
				                                </div>
				                            </div>
                                			<br>
		                        ...
		                        <div class="body">
		                        	<div class="table-responsive">
			                            ...
			                            <div class="col-sm-4">
			                            	...
			                            	<div class="col-sm-2">
			                            		<label for="num_ventas_min_mes_consultar">Ventas Min. al mes*</label>
				                                <div class="form-group">
				                                    <div class="form-line">
				                                        <input type="text" class="form-control" name="num_ventas_min_mes" id="num_ventas_min_mes_consultar" onkeypress='return solonumeros(event)' placeholder="P. EJ. 2" disabled>
				                                    </div>
				                                </div>
				                            </div>

			                                <div class="col-sm-2">
			                            		<label for="num_ventas_max_mes_consultar">Ventas Max. al mes*</label>
				                                <div class="form-group">
				                                    <div class="form-line">
				                                        <input type="text" class="form-control" name="num_ventas_max_mes" id="num_ventas_max_mes_consultar" onkeypress='return solonumeros(event)' placeholder="P. EJ. 2" disabled>
				                                    </div>
				                                </div>
				                            </div>

			                            	<div class="col-sm-4">
				                                <label for="porctj_comision_consultar">% Comisión*</label>
				                                <div class="form-group">
				                                    <div class="form-line">
				                                        <input type="text" class="form-control"  id="porctj_comision_consultar" disabled style="text-align: right;">
				                                    </div>
				                                </div>
				                            </div>
                            			<br>
		                        ...
		                        <div class="body">
		                        	<div class="table-responsive">
			                            <form name="form_comision_actualizar" id="form_comision_actualizar" method="post">
				                            ...
				                            <div class="col-sm-2">
			                            		<label for="">Indicador de ventas de mes*</label>
		                                    	<div class="switch">
												    <label>
												      No
				                            ...
				                            <input type="hidden" name="indicador_venta_actualizar" id="indicador_venta_actualizar" value="N">

				                            <div class="col-sm-2">
			                            		<label for="num_ventas_min_mes_actualizar">Ventas Min. al mes*</label>
				                                <div class="form-group">
				                                    <div class="form-line">
				                                        <input type="text" class="form-control" name="num_ventas_min_mes" id="num_ventas_min_mes_actualizar" onkeypress='return solonumeros(event)' placeholder="P. EJ. 2" disabled>
				                                    </div>
				                                </div>
				                            </div>
				                            
			                            	<div class="col-sm-2">
			                            		<label for="num_ventas_max_mes_actualizar">Ventas Max. al mes*</label>
				                                <div class="form-group">
				                                    <div class="form-line">
				                                        <input type="text" class="form-control" name="num_ventas_max_mes" id="num_ventas_max_mes_actualizar" onkeypress='return solonumeros(event)' placeholder="P. EJ. 2" disabled>
				                                    </div>
				                                </div>
				                            </div>
				                            ...
				                            <div class="col-sm-2">
				                                <label for="porctj_comision_actualizar">% Comisión*</label>
				                                <div class="form-group">
				                                    <div class="form-line">
				                                        <input type="text" class="form-control" name="porctj_comision" id="porctj_comision_actualizar" placeholder="P. EJ. 00,00" required onkeypress="return valida(event)" style="text-align: right;">
				                                    </div>
				                                </div>
				                            </div>
